 ...
 * grid reads as four distinct things at a glance. Rebalancing carries BNB's gold as the flagship;
 * Health Factor is coral rather than amber, which would have collided with it. Values are oklch so
 * they sit at comparable lightness and none shouts louder than the others.
 */
...
export const AGENT_CATALOG: AgentCatalogEntry[] = [
  {
    id: "rebalance",
    accent: { fg: "oklch(0.80 0.157 86)", wash: "oklch(0.80 0.157 86 / 0.08)", edge: "oklch(0.80 0.157 86 / 0.45)" },
  ...
  {
    id: "grid-trading",
    accent: { fg: "oklch(0.72 0.17 305)", wash: "oklch(0.72 0.17 305 / 0.08)", edge: "oklch(0.72 0.17 305 / 0.42)" },
  ...
  },
  {
    ...
    accent: { fg: "oklch(0.76 0.15 165)", wash: "oklch(0.76 0.15 165 / 0.08)", edge: "oklch(0.76 0.15 165 / 0.42)" },
  ...
  },
  {
    ...
    accent: { fg: "oklch(0.70 0.17 22)", wash: "oklch(0.70 0.17 22 / 0.08)", edge: "oklch(0.70 0.17 22 / 0.42)" },
